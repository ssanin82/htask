...
const std::string URL = "wss://api.gateio.ws/ws/v4/";
// const std::string SUBS_MSG = std::format(R"({
//     "time" : {},
//     "channel" : "spot.obu",
//     "event": "subscribe",
//     "payload" : ["ob.BTC_USDT.50"]
// })", time(0));
const std::string SUBS_MSG = std::format(
    "\{\"time\" : {},\"channel\" : \"spot.obu\",\"event\": \"subscribe\",\"payload\" : [\"ob.BTC_USDT.50\"]\}",
    time(0)
);
